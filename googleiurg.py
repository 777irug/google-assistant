...
StartupInfo = '<head><style>body {background-color: white;}</style></head><center><img src="https://raw.githubusercontent.com/777irug/google-assistant/main/background/startup.gif" height="300"></center>'
IconLibrary = os.getcwd()
ApplicationLogo = os.getcwd() + "/VisualElements/VisualElements_512.svg"
...
class GoogleAssistant(QMainWindow):
    ...
    def __init__(self):
        ...
        self.WakeUp = QAction(QIcon(IconLibrary + "/icons/wakeup_btn.png"), "Hey Google", self)
        self.WakeUp.triggered.connect(self.WakeUpGoogleAssistant)
        ...
        self.search_btn = QAction(QIcon(IconLibrary + "/icons/search.png"), "Search", self)
        self.search_btn.triggered.connect(self.GoogleSearch)
    ...
    def WakeUpGoogleAssistant(self):
        try:
            ...
            with sr.Microphone() as source:
                ...
                if "hey google" in KeywordChecker:
                    ...
                    if "time" in KeywordChecker:
                        ...
                        ResultHTML = """
                        <center>
                        <img src="https://raw.githubusercontent.com/777irug/google-assistant/main/background/homepage.gif"><br><br>
                        </center>
                        <hr>
